    ...
    for epoch in range(num_epochs):
        ...
        for images, _, labels in train_pbar:
            ...
            with torch.no_grad():
                ...
                text_embeds = text_out.last_hidden_state[:, 0, :]  # CLS token
...
if __name__ == "__main__":
    ...
    LEARNING_RATE = 0.0009       # Optimizer learning rate
    ...
    MODEL_SAVE = f'SigLIP_seglen{SEGMENT_DURATION_SEC}.pth' # Path to save the best model
